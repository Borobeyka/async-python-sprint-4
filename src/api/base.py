...
@url_router.post("/create", description="Создание короткой ссылки", response_model=ResponseCreatedLinks) # noqa e501
...
@url_router.get("/{short_url}/status", description="Получение статистики URL", response_model=ResponseLinkStats) # noqa e501
...
async def get_link(short_url: str, *, db: AsyncSession = Depends(get_session)): # noqa e501
